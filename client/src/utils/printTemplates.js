...
<style>
  ...
  .container { border: 1.5px solid #000; width: 190mm; margin: 0 auto; display: flex; flex-direction: column; min-height: 255mm; }
...
<div class="container">
  ...
  <div class="summary-section">
    ...
    <div class="summary-right">
      ...
      <div class="math-row"><span style="font-weight:bold">Current Bill Total:</span><span style="font-weight:bold">${s.documentConfig?.currencySymbol || '₹'}${formatIndianNumber((order.itemsTotal || 0) + (order.taxAmount || 0) + (order.loadingCharges || 0) + (order.unloadingCharges || 0) + (order.transportCharges || 0) - (order.discountAmount || 0) + (order.roundOffAmount || 0), 2)}</span></div>
      ${(order.oldBalance || 0) !== 0 ? `<div class="math-row"><span>Old Balance:</span><span>${s.documentConfig?.currencySymbol || '₹'}${formatIndianNumber(order.oldBalance, 2)}</span></div>` : ''}
...
<div class="container">
  ...
  <div class="totals-section">
    ...
    <div class="totals-right">
      ...
      <div class="total-row"><span style="font-weight:bold">Current Bill Total:</span><span><b>${sym}${formatIndianNumber((order.itemsTotal || 0) + (order.taxAmount || 0) + (order.loadingCharges || 0) + (order.unloadingCharges || 0) + (order.transportCharges || 0) - (order.discountAmount || 0) + (order.roundOffAmount || 0), 2)}</b></span></div>
      ${(order.oldBalance || 0) !== 0 ? `<div class="total-row"><span>Old Balance:</span><span>${sym}${formatIndianNumber(order.oldBalance, 2)}</span></div>` : ''}
...
<style>
  ...
  <div class="totals-section">
    ...
    <div class="totals-right">
      ...
      <div class="total-row"><span class="lbl" style="font-weight:bold;color:#333;">Current Bill Total</span><span style="font-weight:bold;color:#333;">${sym}${formatIndianNumber((order.itemsTotal || 0) + (order.taxAmount || 0) + (order.loadingCharges || 0) + (order.unloadingCharges || 0) + (order.transportCharges || 0) - (order.discountAmount || 0) + (order.roundOffAmount || 0), 2)}</span></div>
      ${(order.oldBalance || 0) !== 0 ? `<div class="total-row"><span class="lbl">Old Balance</span><span>${sym}${formatIndianNumber(order.oldBalance, 2)}</span></div>` : ''}
...
<div class="container">
  ...
  <div class="totals-section">
    ...
    <div class="totals-right">
      ...
      <div class="total-row"><span><b>Current Bill Total:</b></span><span><b>${sym}${formatIndianNumber(itemsTotal + (order.taxAmount || 0) + (order.loadingCharges || 0) + (order.unloadingCharges || 0) + (order.transportCharges || 0) - (order.discountAmount || 0) + (order.roundOffAmount || 0), 2)}</b></span></div>
