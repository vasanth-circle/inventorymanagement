    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 pb-24 lg:pb-8">
            <div className="flex items-center space-x-3 pb-2 border-b border-gray-100">
                ...
                <div>
                    <h1 className="text-xl font-bold text-gray-900 leading-tight">Stock Outward</h1>
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Record removal or sales</p>
                </div>
            </div>
