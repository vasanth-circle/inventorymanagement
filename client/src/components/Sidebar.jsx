    ...
    if (activeApp === 'inventory') {
        navGroups = [
        {
            ...
            items: [
                ...
                ...(billingSettings?.industry === 'tiles' ? [{ name: 'Finishes', path: '/finishes', id: 'finishes' }] : []),
                ...( ['tiles', 'garments', 'shoes'].includes(billingSettings?.industry) ? [{ name: 'Manage Sizes', path: '/sizes', id: 'sizes' }] : []),
