...
import { dispatchShipment } from '../controllers/phase2Controller.js';
...
router.post('/:dispatchId/book-shipment', protect, authorize('admin', 'tenant_owner', 'tenant_admin', 'manager', 'godown_staff', 'godown staff', 'staff'), dispatchShipment);
